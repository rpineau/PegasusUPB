...
#define MyAppName "Pegasus Astro X2 Driver"
...
Source: "libPegasusController\Release\libPegasusController.dll"; DestDir: "{app}\Plugins\FocuserPlugins"; Flags: ignoreversion
